...
def dep(window, fromto, listno_pass):
    print('dep')
    
    DepartuePage(window, fromto, listno_pass, 0)
def DepartuePage(window, fromto, listno_pass, tripway):
    global ozbool_list
    bvartt = 6
...
#______________________________________________________________________________________________________________________#   
    ...
    texta = f'{fromto[tripway][0]} ______________________________________________________________________ {fromto[tripway][1]}\n5:00\t\t\t\t\t\t\t6:00'
    textaa = f'\tGOI\t\t\t\tDXB\n\t5:00    \t\t\t\t\t\t       6:00'
    textb = f' From  500 '
    listlist = []
    ...
    if tripway==0:
        ...
        next_btn.configure(command=lambda :dep(window, fromto, listno_pass))
